...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="pull-left page-title">Panels</h4>
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-header">Panel Border</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-header">Panel Fill</h4>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="panel panel-fill panel-warning">
                <div class="panel-heading"> 
                    <h3 class="panel-title">Panel Warning</h3> 
                </div> 
                <div class="panel-body"> 
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="panel panel-fill panel-purple">
                <div class="panel-heading"> 
                    <h3 class="panel-title">Panel Purple</h3> 
                </div> 
                <div class="panel-body"> 
        ...
        <div class="col-lg-4">
            <div class="panel panel-fill panel-pink">
                <div class="panel-heading"> 
                    <h3 class="panel-title">Panel Pink</h3> 
                </div> 
                <div class="panel-body"> 
